...
public class EnterTown : IAgentAction
{
	Actor agent;
	Town town;
	float stayDuration; // how long to stay in town
	...
	public EnterTown(Actor agent, Town town, float stayDuration, System.Action onCompleteFunc = null, System.Action onFailureFunc = null)
	{
		IsDone = false;
		IsStarted = false;
		this.agent = agent;
